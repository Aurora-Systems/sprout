        ...
        <div className="row mb-5 d-flex min-vh-100 flex-row justify-content-center align-items-center mb-5">
          ...
          <div className="col-sm">
            <Fade direction="right" delay={300}>
              ...
              <Link href="/shop"><button className="btn btn-outline-success rounded-pill">Buy Fruits</button></Link>
            </Fade>
          </div>
        </div>
        <div className="row mb-5 d-flex min-vh-100 flex-row justify-content-center align-items-center mb-5">
          ...
          <div className="col-sm">
            <Fade direction="right" delay={300}>
              ...
              <Link href="/shop"><button className="btn btn-outline-success rounded-pill">Buy Vegetables</button></Link>
            </Fade>
          </div>
        </div>
      </div>
